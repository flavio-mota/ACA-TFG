...
for _ in range(3):
    ...
    centros_.append(centroides)


#
#print('Rand: ', cluster.adjusted_rand_score(y, y_aca))
#print(cluster.homogeneity_completeness_v_measure(y,y_aca))
#print(cluster.silhouette_score(X,y_aca, metric='euclidean'))
#plt.scatter(X[y == 0, 0],X[y == 0, 1],c='blue', marker='o',edgecolor='black',s=50)
#plt.scatter(X[y == 1, 0],X[y == 1, 1],c='orange', marker='o',edgecolor='black',s=50)
#plt.scatter(X[y == 2, 0],X[y == 2, 1],c='green', marker='o',edgecolor='black',s=50)
